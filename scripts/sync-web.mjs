...
const webFiles = ['index.html', 'style.css', 'app.js', 'energy.js', 'supabase-config.js', 'supabase-client.js', 'auth.js', 'cultivo-models.js', 'cultivo-db.js', 'cultivo-repository.js', 'cultivo-migration.js', 'cultivation.js', 'products.js', 'recipes.js', 'workspaces.js'];
